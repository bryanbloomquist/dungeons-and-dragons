...
const AddPC = () => {
	return (
		<Form>
			<Form.Group className="m-2" controlId="formAddPlayerName">
				<Form.Label>Character Name</Form.Label>
				<Form.Control type="text" placeholder="Enter name..." />
			</Form.Group>
			<Form.Group className="m-2" controlId="formAddPlayerInitiative">
				<Form.Label>Initiative Roll</Form.Label>
				<Form.Control type="number" placeholder="Enter initiative..." />
			</Form.Group>
			<Form.Group className="m-2" controlId="formAddPlayerArmorClass">
